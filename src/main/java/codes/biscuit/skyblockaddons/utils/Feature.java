...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // Removed, added to Skyblock.
    ...
    HEAD_TRANSPARENCY_FIX(75, Message.SETTING_HEAD_TRANSPARENCY_FIX, false),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            CAKE_BAG_PREVIEW, BACKPACK_PREVIEW_AH, REPEAT_FULL_INVENTORY_WARNING, SORT_TAB_EFFECT_TIMERS, HEAD_TRANSPARENCY_FIX);
